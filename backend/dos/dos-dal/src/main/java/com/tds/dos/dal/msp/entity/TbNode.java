...
public class TbNode {
    ...
    private Integer fRayPort;
    private String fRayStatus;
    private String fExternalEndpoint;
    private String fRayEndpoint;
    ...
    public String getfMachineIp() { return fMachineIp; }
    public void setfMachineIp(String fMachineIp) { this.fMachineIp = fMachineIp; }
    public Integer getfRayPort() { return fRayPort; }
    public void setfRayPort(Integer fRayPort) { this.fRayPort = fRayPort; }
    public String getfRayStatus() { return fRayStatus; }
    public void setfRayStatus(String fRayStatus) { this.fRayStatus = fRayStatus; }
    ...
    public String getfRayEndpoint() { return fRayEndpoint; }
    public void setfRayEndpoint(String fRayEndpoint) { this.fRayEndpoint = fRayEndpoint; }
